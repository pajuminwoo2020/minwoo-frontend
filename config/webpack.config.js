...
module.exports = function(webpackEnv) {
  ...
  console.log('>> webpack isEnvProduction', isEnvProduction);
  console.log('>> webpack shouldUseSourceMap', shouldUseSourceMap);
