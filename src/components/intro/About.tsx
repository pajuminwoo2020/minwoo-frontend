...
const AboutWrapper = styled.div`
  ...
  .about-text p {
	...
	.about-text.about-emphasize {
		color: #f86e6b;
		text-decoration: underline;
		font-weight: bold;
	}

	.about-text.about-declare {
		padding-top: 100px;
		padding-left: 50px;
	}
			...
			<Tabs defaultActiveKey="1" type="card">
				<TabPane tab="소개" key="1">
					<div className="about-row">
						<div className="float-left about-text about-top-text">
							<p>
								<strong>
							...
							<p>
								<div className="about-text about-emphasize">
				...
				<TabPane tab="창립선언문 & 회원다짐" key="2">
					...
					<div className='about-row'>
						<div className='float-left'>
							<img src={MinwooFoundingStatement} />
						</div>
						<div className="float-left about-text about-declare">
							<strong>
								우리는
							</strong>
							<br />
